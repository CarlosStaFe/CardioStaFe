		...
		<div class="topbar d-flex align-items-center">
			<div class="container d-flex justify-content-center justify-content-md-between">
				<div class="contact-info d-flex align-items-center">
					<i class="bi bi-envelope d-flex align-items-center"><a href="mailto:carlos.a.mayans@gmail.com">carlos.a.mayans@gmail.com</a></i>
					<i class="bi bi-phone d-flex align-items-center ms-4"><span>+549 342 4565514</span></i>
				</div>
				...
				<div class="row gy-4 gx-5">
					...
					<div>
						<div class="section-title" data-aos="fade-up">
							...
							<p>Para reservar debe ingresar al sistema</p>
						</div>
					</div>
