...
class EventController extends Controller
{
    ...
    public function createBackup(Request $request)
    {
        try {
            ...
            Log::info('Ejecutando comando backup eventos', ['command' => $logCommand]);
            ...
            Log::info('Resultado comando backup eventos', [
    ...
    public function restoreBackup(Request $request)
    {
        ...
        try {
            ...
            Log::info('Ejecutando comando restauración eventos', ['command' => $logCommand]);
